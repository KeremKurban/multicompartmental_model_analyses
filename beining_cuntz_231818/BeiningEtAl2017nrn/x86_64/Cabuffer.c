...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 13, "diam");
 	...
 	ivoc_help("help ?1 Cabuffer /home/kurban/Documents/neuron_examples/beining_cuntz_231818/BeiningEtAl2017nrn/lib_mech/Cabuffer.mod\n");
 ...
 v=_v;
{
  ...
  tcai = _ion_tcai;
 { error =  state();
 if(error){fprintf(stderr,"at line 49 in file Cabuffer.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } {
   }
  _ion_cai = cai;
  _ion_cao = cao;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/kurban/Documents/neuron_examples/beining_cuntz_231818/BeiningEtAl2017nrn/lib_mech/Cabuffer.mod";
static const char* nmodl_file_text = 
