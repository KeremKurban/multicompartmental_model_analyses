...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdr /home/kurban/Documents/NEURON/ferrante_migliore_124291/FFI/Granule_Fig_1B_right/kdr.mod\n");
...
static int  rates (  double _lv ) {
  ...
  _zq10 = 1.0 ;
   _lalpha = - .028 * vtrap ( _threadargscomma_ ( _lv + 70.0 - 35.0 ) , - 6.0 ) ;
   _lbeta = .1056 * exp ( ( _lv + 70.0 - 10.0 ) / 40.0 ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/kurban/Documents/NEURON/ferrante_migliore_124291/FFI/Granule_Fig_1B_right/kdr.mod";
static const char* nmodl_file_text = 
  "TITLE kdr.mod\n"
  " \n"
  "COMMENT\n"
