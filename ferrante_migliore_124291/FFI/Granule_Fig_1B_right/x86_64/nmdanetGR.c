...
#define nmdafactor _p[3]
#define nmdafactor_columnindex 3
#define i _p[4]
#define i_columnindex 4
#define g _p[5]
#define g_columnindex 5
#define Ron _p[6]
#define Ron_columnindex 6
#define Roff _p[7]
#define Roff_columnindex 7
#define synon _p[8]
#define synon_columnindex 8
#define DRon _p[9]
#define DRon_columnindex 9
#define DRoff _p[10]
#define DRoff_columnindex 10
#define _g _p[11]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 nmdanet /home/kurban/Documents/NEURON/ferrante_migliore_124291/FFI/Granule_Fig_1B_right/nmdanetGR.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   g = nmdafactor * mgblock ( _threadargscomma_ v ) * ( Ron + Roff ) * 1.0 ;
   i = g * ( v - Erev ) ;
   }
 _current += i;
...
{
 { error =  release();
 if(error){fprintf(stderr,"at line 98 in file nmdanetGR.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/kurban/Documents/NEURON/ferrante_migliore_124291/FFI/Granule_Fig_1B_right/nmdanetGR.mod";
static const char* nmodl_file_text = 
  "TITLE simple NMDA receptors\n"
  "\n"
  ": Modified from the original AMPA.mod, M.Migliore Jan 2003\n"
  ": nmdafactor of 2.65 gives a peak conductance of 1nS in 0Mg\n"
  "\n"
  "COMMENT\n"
  "-----------------------------------------------------------------------------\n"
  "\n"
  ...
  "	Alpha	= 0.1		(/ms)	: forward (binding) rate\n"
